...
def main() -> None:
    ...
    scope_name = {"all": "四问", "q1": "问题一", "q2": "问题二", "q3": "问题三", "q4": "问题四"}[args.only]
    pd.DataFrame(summary_rows).to_csv(
        OUT / f"{scope_name}_正式结果汇总.csv", index=False, encoding="utf-8-sig"
    )
    manifest = {
    ...
    (OUT / f"{scope_name}_正式结果导出清单.json").write_text(
