...
\bibitem{ref4} DeepSeek. DeepSeek V4 Pro 大语言模型[CP/OL]. 2025.

\bibitem{ref5} Alibaba Cloud. 通义千问(Qwen) 3.7 Max 大语言模型[CP/OL]. 2025.
...
problem2\_extra\_plots.py   & 问题二附加可视化代码 \\
...
\lstinputlisting[language=Python, caption={问题二附加可视化代码}]{code/problem2_extra_plots.py}
